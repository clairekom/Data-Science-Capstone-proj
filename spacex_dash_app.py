# to run localy using Jupyter Lab, open a terminal and run
# pip install pandas dash
# wget "https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-DS0321EN-SkillsNetwork/datasets/spacex_launch_dash.csv"
# wget "https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-DS0321EN-SkillsNetwork/labs/module_3/spacex_dash_app.py"
# python spacex_dash_v1b.py
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                searchable=True,
                                style={'width':'80%', 'padding': '3px', 'font-size': 20, 'textAlign':'left'}
                                            )
                                ]), 
                                html.Br(),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df_site = filtered_df['class'].value_counts().reset_index()
...
def get_scatter_plot(entered_site, entered_payload): 
    if entered_site == 'ALL':
        filtered_df1 = spacex_df[ (spacex_df['Payload Mass (kg)'] >= entered_payload[0]) & 
